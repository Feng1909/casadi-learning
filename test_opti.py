...
lambda_1 = opti.variable()
lambda_2 = opti.variable()
lambda_3 = opti.variable()
lambda_4 = opti.variable()
...
opti.minimize(M)
opti.subject_to(lambda_1 > 0.01)
opti.subject_to(lambda_2 > 0.01)
opti.subject_to(lambda_3 > 0.01)
opti.subject_to(lambda_4 > 0.01)

opti.solver('qpoases')

opti.set_initial(lambda_1, 0.6982)
opti.set_initial(lambda_2, 0)
opti.set_initial(lambda_3, 0)
opti.set_initial(lambda_4, 0)
...
print(sol.value(lambda_1))
print(sol.value(lambda_2))
print(sol.value(lambda_3))
print(sol.value(lambda_4))
print((tim2-tim1))
